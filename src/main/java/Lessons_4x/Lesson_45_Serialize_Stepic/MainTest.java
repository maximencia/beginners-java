...
public class MainTest {
    ...
    public static void beforeClass() {
        mainClass = TestUtils.getUserClass("Lessons_4x.Lesson_45_Serialize_Stepic.Animal");   // see Demo!
    ...
    public static byte[] serialize(int count, Object[] objects) throws IOException {
