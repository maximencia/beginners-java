...
public class Test {
    public static void main(String[] args) {
        ...
        //test(ListofDog); //  Error:(21, 14) java: incompatible types: java.util.List<Lessons_3x.Lesson_34_WILDCARD_Generic.Lessons_2x.Lesson_26_inheritance.Dog> cannot be converted to
        // java.util.List<Lessons_3x.Lesson_34_WILDCARD_Generic.Animal34>
        test2(ListofDog);
